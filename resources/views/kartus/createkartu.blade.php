<x-bootstrap>
  ...
  <form action="/kartu/with-model" method="POST">
    ...
    <div class="mb-3">
      <label for="pemilik_uttp" class="form-label">pemilik_uttp</label>
      <input type="text" class="form-control  @error('pemilik_uttp') is-invalid @enderror" id="pemilik_uttp" name="pemilik_uttp" value="{{ old('pemilik_uttp') }}" placeholder="Pemilik UTTP">
